...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{img/testy/obiekt.jpg}
...
\begin{figure}
    \centering
    \includesvg[width=0.65\textwidth]{img/testy/surowe_wykryte.svg}
...
\begin{figure}
    \centering
    \includesvg[width=0.65\textwidth]{img/testy/nachylenie.svg}
