...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{img/obiekt.jpg}
...
\begin{figure}
    \centering
    \includesvg[width=0.65\textwidth]{img/surowe_wykryte.svg}
...
\begin{figure}
    \centering
    \includesvg[width=0.65\textwidth]{img/nachylenie.svg}
