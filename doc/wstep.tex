...
W sektorze bezpieczeństwa publicznego wykrywacze stanowią witalny element zabezpieczenia lotnisk oraz innych miejsc masowych zgromadzeń ludzi. Systemy bramek sygnalizujących obecność metalu pozwalają na szybkie i nieinwazyjne zapewnienie bezpieczeństwa, chroniąc przed wnoszeniem niebezpiecznych przedmiotów, takich jak ostre narzędzia, czy broń palna. Ręczne detektory metali, stosowane przez funkcjonariuszy publicznych jak i ochronę pozwalają na przefiltrowanie osób przed wejściem na imprezy masowe.
...
\section{Cel pracy}
Głównym celem pracy jest zaprojektowanie, wykonanie oraz przetestowanie prototypu wykrywacza metali z wykorzystaniem łatwo dostępnych komponentów elektronicznych.
Projekt zakłada stworzenie w pełni funkcjonalnego urządzenia mobilnego umożliwiającego skuteczną detekcję metalu w różnych środowiskach.
Realizacja tego celu wymaga połączenia wiedzy z zakresu elektrodynamiki, elektroniki analogowej, elektroniki cyfrowej oraz inżynierii systemów wbudowanych.
