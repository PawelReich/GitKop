...
Wykrywacz generuje sygnał za pomocą układu STM32F411RE, który za pomocą sprzętowego licznika wyzwala sygnał \textit{PULSE\_IN} trwający $300 \mu s$  co $10 ms$.
...
\begin{figure}[H]
    ...
    \end{center}
    \caption{sch}\label{fig:wzmocnienie}
\end{figure}
...
Część cyfrowa wykrywacza metalu oparta jest o układ \textbf{STM32H523CE}. Ten produkowany przez ST Microelectronics mikrokontroler posiada jeden rdzeń oparty na architekturze ARM\textregistered{} Cortex-M33\textregistered{} \cite{st_stm32h5_web} \cite{st_stm32h533_ds} oraz m.in wykorzystane w projekcie układy peryferyjne:

\subsection{Liczniki sprzętowe}
\label{subsec:timery}
Wykorzystywane są dwa 16-bitowe liczniki sprzętowe napędzane za pomocą zegara \textit{APB2} skonfigurowanego na taktowanie z częstotliwością $F_{timer}=72Mhz$. Częstotliwość przepełnienia licznika sprzętowego można wyznaczyć za pomocą poniższego równania: 
...
\cite{WeActStudio_STM32H523CoreBoard}
