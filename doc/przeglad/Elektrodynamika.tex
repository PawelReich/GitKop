...
W kontekście inżynierii systemów detekcji cewka nadawcza zasilana jest prądem zmiennym lub impulsowym, w efekcie czego generuje zmienny strumień magnetyczny. Strumień ten penetruje przestrzeń, w tym potencjalne obiekty przewodzące oraz grunt. Zgodnie z przytoczonym prawem, zmienność strumienia w czasie ($\partial \mathbf{B}/\partial t$) indukuje siłę elektromotoryczną w każdym przewodniku objętym polem.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.3\textwidth]{img/moreland_induction_eddy.png} 
    \end{center}
    \caption{Wpływ pola elektromagnetycznego na tworzenie prądów wirowych na przykładzie monety}\label{fig:eddy}
    \hfill\small źródło: C. Moreland \cite{moreland_induction} 
\end{figure}

\todo[inline]{przetlumaczyc}
