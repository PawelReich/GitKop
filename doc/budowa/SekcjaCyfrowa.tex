...
\begin{itemize}
    ...
    \item CNT (Licznik, ang. \textit{Counter}) - przechowuję aktualną liczbę tyknięć licznika
\end{itemize}
...
Podczas wykonywania algorytmu wykrywania kopiowany jest segment bufora uzupełnianego przez DMA zawierający ostatnie $N=42$ próbek i dokonywany jest proces analizy nachylenia sygnału.
